        ...
        <section className="mb-16">
          ...
          <div className="mt-6" data-aos="fade-right">
            ...
            <h1
              ...
              className="text-xl cursor-pointer font-Red_Hat_Display text-center font-semibold hover:text-megamind_red dark:text-megamind_red dark:hover:text-megamind_white"
            >
              Noah Oliver Elijah
            </h1>
          </div>
