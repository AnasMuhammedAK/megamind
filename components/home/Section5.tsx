      ...
      <div className=" w-full 2xl:px-96 px-4 md:px-10 lg:px-20 xl:px-64 ">
        <div className="grid grid-cols-2 lg:grid-cols-4 md:gap-10 ">
          <div data-aos="fade-up-right" className=" ">
            <h1 className="text-megamind_red md:text-7xl xl:text-8xl text-4xl font-bold text-center ">
              35k
            </h1>
            <h3 data-aos="fade-left" className="text-center dark:text-white md:text-lg mt-2">
          ...
          <div data-aos="fade-up-left" className=" ">
            ...
            <h3 data-aos="fade-right" className="text-center dark:text-white md:text-lg mt-2">
              3,280 avg Rating
            </h3>
          </div>
          <div data-aos="fade-up-left" className=" ">
