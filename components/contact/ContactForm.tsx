      ...
      <div className="md:flex items-center mt-12">
        <div data-aos="zoom-in-up" className="md:w-72 flex flex-col">
          ...
          <input
            ...
            type="name"
            className="text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-megamind_red mt-4 bg-white border rounded border-megamind_black/10 dark:border-megamind_red/50  placeholder-megamind_black/40"
      ...
      <div>
        <div data-aos="zoom-in-up" className="w-full flex flex-col mt-8">
          ...
          <textarea
            ...
            role="textbox"
            className="h-36 text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-megamind_red mt-4 bg-white border rounded border-megamind_black/10 dark:border-megamind_red/50  placeholder-megamind_black/40 resize-none"
            defaultValue={""}
          />
          <p className="text-red-400 text-[13px]">
